...
<h4 align="left">⭐️ Hi, I'm Vaanya, a software engineer passionate about AI, systems, and secure technologies. I enjoy building projects that combine backend, AI, and real-world applications, and I’m currently exploring multi-agent systems, machine learning, and blockchain-based solutions.</h4>

- 🌱 I’m currently keeping up with university coursework and exploring large language models (LLMs) and agentic AI.
...
<img src="https://img.shields.io/badge/-JavaScript-black?logo=javascript&logoColor=yellow&style=flat" height="25"/>
...
<img src="https://img.shields.io/badge/-C++-f54997?logo=cplusplus&logoColor=white&style=flat" height="25"/>
</p>
...
<ul>
<li><b>MotionMate</b> – AI-powered, multi-threaded application for real-time video inference, focusing on concurrent processing and low-latency API responses using Python, OpenCV, MediaPipe, and Google Gemini API.</li>
<li><b>Blockchain E-Voting System</b> – Backend and admin dashboard for a secure blockchain-based election platform. Implemented encrypted vote transfers, role-based access, and immutable vote storage using Node.js, Express.js, MongoDB Atlas, JWT, bcrypt, Hyperledger Fabric, and React.</li>
</ul>
